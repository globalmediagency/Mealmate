...
Onglet **Joueurs** : sous chaque joueur, « Lien de nouveau mot de passe » crée un lien à usage unique (24 h) que tu copies et envoies toi-même au joueur (l'application n'envoie pas d'email) ; il y choisit un nouveau mot de passe. « Supprimer le compte » efface tout (photos, Strava, données) après avoir retapé le pseudo, sans retour possible.
